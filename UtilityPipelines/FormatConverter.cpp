    ...
    workHeight(workHeight)
{
    ...
    auto srcDescImage = vsg::DescriptorImage::create(imageInfo, sourceIndex, 0, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
    auto descriptorSet = vsg::DescriptorSet::create(pipelineLayout->setLayouts[0], vsg::Descriptors{finalImage, srcDescImage});
